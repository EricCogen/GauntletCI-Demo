...
{
    private static readonly string DefaultApiKey = "use-env-var";

    private readonly HttpClient _http;
    private readonly ILogger<PaymentClient> _logger;
    private readonly string _apiBaseUrl;

    public PaymentClient(HttpClient http, ILogger<PaymentClient> logger, string apiBaseUrl)
    {
    ...
    public async Task<bool> ChargeAsync(Order order, CancellationToken ct = default)
    {
        ...
        req.Headers.Add("X-Api-Key", DefaultApiKey);
